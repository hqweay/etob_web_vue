...
module.exports = {
  dev: {
    ...
    // Paths
    assetsSubDirectory: 'static',//必须 涉及到热部署
    assetsPublicPath: '/',
    proxyTable: {},
    ...
    errorOverlay: true,
    notifyOnErrors: true,
    poll: 1000, //设置监听时间 热更新用 https://webpack.js.org/configuration/dev-server/#devserver-watchoptions-
    ...
    proxyTable: {
      '/api': {  //使用"/api"来代替"http://localhost:8089" 
        ...
        // target: 'http://silver.hqweay.cn:8080', //源地址 
      ...
      '/web': {
        target: 'http://etob.hqweay.cn:89/api', //源地址 
        changeOrigin: true, //改变源 
        pathRewrite: {
          '^/web': '/api'
        }
