...
<div class="chat_room">
   <ul class="comments">
      ...
      <!-- <li class="comment">
        <small class="c_info">{{ messages.date }}</small>
        <a class="c_info username" href="">{{ messages.username }}</a>
        <div class="c_info message">
          {{ messages.message }}
        </div>
      </li> -->
...
const sock = new SockJS("/web/StompPort");
...
export default {
  ...
  created: function() {
    ...
    this.$ajax({
      method: "get",
      url: "/web/charRoom/getNewTenMessage"
    }).then(data => {
      // this.messages = [];
      // this.messages.push(data.data[6]);
      // this.messages.push(data.data[7]);
      // this.messages.push(data.data[8]);
      // this.messages.push(data.data[9]);
      // this.messages.push(data.data[10]);
      // this.messages.push(data.data[11]);
      // this.messages.push(data.data[12]);
    ...
    subscribe() {
      stomp.connect("guest", "guest", frame => {
        stomp.subscribe("/topic/chatRoom", message => {
          ...
          // this.messages = [];
          // this.messages.push(spittle[6]);
          // this.messages.push(spittle[7]);
          // this.messages.push(spittle[8]);
          // this.messages.push(spittle[9]);
          // this.messages.push(spittle[10]);
          // this.messages.push(spittle[11]);
          // this.messages.push(spittle[12]);
